  ...
  Client.prototype.onMessage = function(message) {
    ...
    switch (message.type) {
      ...
      case 'reaction_removed':
        m = new Message(this, message);
        return this.emit('reaction_removed', m);
      case 'reaction_added':
        m = new Message(this, message);
        return this.emit('reaction_added', m);
      default:
        if (message.reply_to) {
          ...
          if ((_ref = message.type) !== "file_created" && _ref !== "file_shared" && _ref !== "file_unshared" && _ref !== "file_comment" && _ref !== "file_public" && _ref !== "file_comment_edited" && _ref !== "file_comment_deleted" && _ref !== "file_change" && _ref !== "file_deleted" && _ref !== "star_added" && _ref !== "star_removed" && _ref !== "reaction_removed" && _ref !== "reaction_added") {
